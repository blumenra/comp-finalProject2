...
(define primitive-funcs 
    (lambda (lst)
        (append 
            ...
            ass-div-bin ass-mul-bin ass-append-bin
...
(define ass-append-bin
    (lambda ()      
        (let* 
            ((address (find-address 'ass-append-bin global-var-table))
            (start_label "L_append_bin")
            (make_label (string-append "L_make_" start_label))
            (end_label (string-append "." start_label "_done")))
            (string-append 
                "jmp " make_label " \n" 
                ...
                "mov r10, 0 \n"
                "TAKE_ARG rbx, r10 \n" ;; rbx = first arg = left list
                "mov r10, 1 \n"
                "TAKE_ARG rcx, r10 \n" ;; rcx = second arg = right list
		...
		"mov rax, rcx \n"
                ...
                ;; At this point, all the elements of list 1 is on the stack
                ...
                ;; At this point, all the elements of list 1 and list 2 are on the stack
...
(define ass-append
    (lambda ()      
        (let* 
            ((address (find-address 'append global-var-table))
            (start_label "L_append")
            (make_label (string-append "L_make_" start_label))
            (end_label (string-append "." start_label "_done")))
            (string-append 
                "jmp " make_label " \n" 
